  ...
  <div class="trendAnalysisUnit">
    ...
    <div class="groupSum">
      ...
      <div class="line" id="ttt">
        <div id="serverGroupLine" style="width: 100%; height: 400px; margin: 0 auto;"></div>
      </div>
    </div>
    ...
    <div class="userSum">
      ...
      <!-- 服务问题KPI折线图样式 -->
      <div class="line" id="ttt">
        <div id="mepLineGroup" style="width: 100%; height: 400px; margin: 0 auto;"></div>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    groupInitItem(
      ...
      let myChart1 = this.$echarts.init(document.getElementById("serverGroupLine"));
      const option1 = {
        title: {
          text: "主机状态趋势",
          left: "50%",
    ...
    mepInitItem(
      ...
      this.initWidth = document.getElementById("ttt").offsetWidth;
      let myChart4 = this.$echarts.init(document.getElementById("mepLineGroup"));
      const option4 = {
        title: {
          text: "主机问题处理率趋势",
          left: "50%",
...
@import "../../../../css/hostFile/trendAnalysisUnit.css";
</style>
