      ...
      <el-aside class="left" width="200px">
        ...
        >
          ...
          <el-submenu index="2">
            ...
            <!-- 产品数据分析 -->
            <el-menu-item
              index="/productDataAnalysis"
              style="padding-left: 60px; disabled"
              @click="dashboard5"
            >
            ...
            <el-menu-item index="/users/informationSecurity" style="padding-left: 60px">
              ...
              <i class="informationSecurityNum">
                <P>100</P>
              </i>
            </el-menu-item>
          ...
          <el-submenu index="1">
            ...
            <!-- 配置展开内容 -->
            <!-- 场景频次监控 -->
            <el-menu-item index="/users/usersFrequency" style="padding-left: 60px">
              <span slot="title">场景频次监控</span>
            </el-menu-item>

            <!-- 场景性能监控 -->
            <el-menu-item index="/users/scenarioFrequency" style="padding-left: 60px">
          ...
          <el-submenu index="4">
            <!-- 总览 -->
            <template v-slot:title>
              <i class="el-icon-caret-bottom" :class="{ cgcolor: actives4 }"></i>
          ...
          <el-submenu index="5">
            <!-- 服务 -->
            <template v-slot:title>
              <i class="el-icon-caret-bottom" :class="{ cgcolor: actives5 }"></i>
          ...
          <el-submenu index="6">
            <!-- 主机 -->
            <template v-slot:title>
              <i class="el-icon-caret-bottom" :class="{ cgcolor: actives6 }"></i>
          ...
          <el-submenu index="7">
            <!-- 地图 -->
            <template v-slot:title>
              <i class="el-icon-caret-bottom" :class="{ cgcolor: actives7 }"></i>
            ...
            <!-- 通知 -->
            <el-menu-item index="/users/notice" style="padding-left: 60px">
              <span slot="title">通知</span>
            </el-menu-item>
            <!-- 系统 -->
            <el-menu-item index="/users/system" style="padding-left: 60px">
          ...
          <el-submenu index="9">
            <!-- 事件 -->
            <template v-slot:title>
              <i class="el-icon-caret-bottom" :class="{ cgcolor: actives9 }"></i>
            ...
            <!-- 监控事件 -->
            <el-menu-item index="/users/MonitEvent" style="padding-left: 60px">
              <span slot="title">监控事件</span>
            </el-menu-item>
            <!-- 用户操作事件 -->
            <el-menu-item index="/users/UserActionEvent" style="padding-left: 60px">
              <span slot="title">用户操作事件</span>
            </el-menu-item>
            <!-- 问题处理 -->
            <el-menu-item index="/users/problemSolve" style="padding-left: 60px">
