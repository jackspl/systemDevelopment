<template>
  <div class="specificClient">
    ...
    <el-row>
      <el-col :span="4">
        <div id="main333" style="width: 100%; height: 430px"></div>
      </el-col>
      <el-col :span="20">
          ...
          <div class="grid-content bg-purple-dark">
            ...
            >
              ...
              <el-table-column
                ...
                label="主机名"
              ></el-table-column>
              <el-table-column prop="sceneNameDesc" align="center" width="150" label="场景名"></el-table-column>
...
export default {
  ...
  methods: {
    // 图表
    pageImg (normalCounts,seriousCounts) {
    ...
    handleDownload () {
      ...
      import('@/utils/Export2Excel').then(excel => {
        const tHeader = ['客户端', '场景名', '场景操作次数']
        const filterVal = ['hostName', 'sceneNameDesc', 'operationCount']
    ...
    async getUserListBegin (valuee) {
      ...
      try {
        ...
        if (tableList === null) {
          ...
          this.pageImg(normalCounts,seriousCounts)
...
@import "../../../../../css/clientSideMonitor/sceneMonitor/sceneFrequencyMonitor/specificClient.css";
</style>
