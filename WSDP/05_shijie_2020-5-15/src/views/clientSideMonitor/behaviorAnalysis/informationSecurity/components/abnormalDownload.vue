  ...
  <div class="abnormalDownload clearfix">
        ...
        <div class="seachF3">
          ...
          <div class="switchSum clearfix">
            <div class="acrossDepDown">
              <el-switch v-model="value2" inactive-text="跨部门"></el-switch>
            </div>
            <div class="sizeOverweight">
              <el-switch v-model="value3" inactive-text="大小超标"></el-switch>
            </div>
            <div class="confDocumentsDown">
              <el-switch v-model="value4" inactive-text="机密文件"></el-switch>
            </div>
            <div class="numOverweight">
              <el-switch v-model="value5" inactive-text="数量超标"></el-switch>
            </div>
          </div>
        </div>
        <div class="seachF4">
    ...
    <div class="tableList">
      ...
      >
        ...
        <el-table-column align="center" prop="employeeName" label="文档所属公司"></el-table-column>
        <el-table-column align="center" prop="hostNameGroup" label="文档所属部门"></el-table-column>
        <el-table-column align="center" prop="hostName" label="跨部门"></el-table-column>
        <el-table-column align="center" prop="IP" label="机密"></el-table-column>
        <el-table-column align="center" prop="employeeName" label="大小超标"></el-table-column>
        <el-table-column align="center" prop="employeeName" label="数量超标"></el-table-column>
        <el-table-column align="center" prop="employeeName" label="文档名称"></el-table-column>
      </el-table>
    </div>
    <!-- 分页 -->
