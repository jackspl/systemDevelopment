<template>
  <div class="specificContextUser">
    ...
    <el-row>
      <el-col :span="4">
        <div id="main444" style="width: 100%; height: 430px"></div>
      </el-col>
      <el-col :span="20">
...
export default {
  ...
  methods: {
    ...
    pageImg (normalCounts,seriousCounts) {
      let myChart444 = this.$echarts.init(document.getElementById('main444'))
      const option444 = {
        color: ['#98c831', '#eb1460'],
        animation: false,
        tooltip: {
    ...
    handleDownload () {
      ...
      import('@/utils/Export2Excel').then(excel => {
        const tHeader = ['场景名', '用户名', '场景操作次数']
        const filterVal = ['sceneNameDesc', 'userId', 'operationCount']
