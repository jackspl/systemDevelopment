      ...
      <el-form :inline="true" :model="form" ref="form">
        ...
        <div class="cond">
          ...
          <el-form-item label="搜索条件">
            <el-select
              ...
              placeholder="北京公司 研发部 白彦斌 异常登录 2019年 上半年"
            >
              <el-option
                label="北京公司 研发部 白彦斌 异常登录 2019年 上半年"
                value="shanghai"
              ></el-option>
              <el-option
                label="成都公司 制造部 刘伟 异常登录 2019年 下半年"
                value="beijing"
              ></el-option>
              <el-option
                label="广州公司 销售部 张斌 异常登录 2019年 上半年"
                value="chengdu"
              ></el-option>
            </el-select>
          </el-form-item>
        ...
        <div class="slideButton clearfix">
          <div
            class="allButton"
            @click="allButton"
            :class="{ textColor: flagAll }"
          >
            所有登录
          </div>
          <div
            class="abnormalButton"
            @click="abnormalButton"
            :class="{ textColor: flagAbn }"
          >
            异常登录
          </div>
        </div>
