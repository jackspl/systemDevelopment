          ...
          <div class="content">
            <el-row>
              ...
              ></el-table-column>
                    ...
                    <el-table-column align="center" sortable="coumnt" prop="operationMinTime" label="最小响应时间(s)"></el-table-column>
                    <el-table-column align="center" sortable="coumnt" prop="operationAvgTime" label="平均响应时间(s)"></el-table-column>
                    <el-table-column align="center" sortable="coumnt" prop="operationMaxTime" label="最大响应时间(s)"></el-table-column>
                    <el-table-column align="center" prop="userId" label="次数"></el-table-column>
                    <el-table-column align="center" prop="userId" label="总时间"></el-table-column>
...
export default {
  ...
  data () {
    return {
      ...
      // 表格数据
      userList: [],
      filename: '基于特定场景（用户）监控' + moment().format('YYYY年MM月DD日'),
...
@import "../../../../../css/clientSideMonitor/sceneMonitor/scenePerformanceMonitor/scenSceUser.css";
</style>
