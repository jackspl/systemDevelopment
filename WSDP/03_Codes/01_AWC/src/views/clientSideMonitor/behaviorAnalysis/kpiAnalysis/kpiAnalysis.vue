...
import kpiTrendAnalysis from "./components/kpiTrendAnalysis";
import kpiDetailsQuery from "./components/kpiDetailsQuery";
...
// .kpiAnalysis .right .el-tabs__item {
//   width: 120px;
//   text-align: center;
// }
</style>
