  ...
  <div class="kpiDetailsQuery" >
    <div class="seachAll">
      <el-form :inline="true" :model="form" ref="form">
        ...
        <!-- 公司选择 -->
        <div class="comChange" v-if="comDiv" v-cloak>
        ...
        <!-- 部门选择 -->
        <div class="depChange" v-if="depDiv" v-cloak>
        ...
        <!-- 员工选择 -->
        <div class="userChange" v-if="empDiv" v-cloak>
        ...
        <!-- 主机名选择 -->
        <div class="hostChange" v-if="hostDiv" v-cloak>
    ...
    <div class="execel" v-cloak>
      ...
      >
        <el-table-column type="selection" align="center" border v-cloak></el-table-column>
        <el-table-column type="index" label="序号" align="center" :index="table_index" v-cloak></el-table-column>
        <el-table-column prop="employeeName" label="姓名" align="center" v-if="nameShow" v-cloak></el-table-column>
        <el-table-column prop="company" label="公司" align="center" v-cloak></el-table-column>
        <el-table-column prop="employeeGroup" label="部门" align="center" v-if="empNameShow" v-cloak></el-table-column>
        <el-table-column prop="hostName" label="主机名" align="center" v-if="hostNameShow" v-cloak></el-table-column>
        <el-table-column label="加分" align="center" v-cloak>
          <el-table-column prop="workingHours" align="center" label="有效工时" sortable="coumnt"></el-table-column>
          <el-table-column prop="operaCount" align="center" label="场景次数" sortable="coumnt"></el-table-column>
          ...
          <el-table-column prop="projectWeighting" align="center" label="项目加权" sortable="coumnt"></el-table-column>
        </el-table-column>
        <el-table-column label="减分" align="center">
          <el-table-column
            prop="infoSafeViolation"
            align="center"
            label="信息安全违规"
            height="20"
            sortable="coumnt"
          ></el-table-column>
          <el-table-column prop="irregularOperation" align="center" label="不规范操作" sortable="coumnt"></el-table-column>
        </el-table-column>
...
export default {
  ...
  methods: {
    ...
    empRadio() {
      ...
      this.nameShow = true;
      this.empNameShow = true;
      this.hostNameShow = true;
    },
    // 排序方法
    sort_change(column) {
      this.pagesNum = 1; // 排序后返回第一页
      if (column.prop === "workingHours") {
        // 表格每一列对应的字段，必须一一对应
    ...
    async getTabList() {
      ...
      try {
        ...
        // const peonList = kpiEntityList.reduce((cur,next) => {
        //   reduceList[next.employeeName] ? "" : reduceList[next.employeeName] = true && cur.push(next);
        //   return cur;
        // }, [])
        this.total = tableTotalList[0];
        // this.total = peonList.length;
