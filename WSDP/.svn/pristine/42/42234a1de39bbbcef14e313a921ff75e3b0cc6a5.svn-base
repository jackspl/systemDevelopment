          ...
          <div class="content">
            <el-row>
              ...
              ></el-table-column>
                    ...
                    <el-table-column align="center" prop="hostName" label="次数"></el-table-column>
                    <el-table-column align="center" prop="hostName" label="总时间"></el-table-column>
...
export default {
  ...
  data () {
    return {
      ...
      // 表格数据
      userList: [],
      filename: '基于客户端监控' + moment().format('YYYY年MM月DD日'),
...
@import "../../../../../css/clientSideMonitor/sceneMonitor/scenePerformanceMonitor/scenMachine.css";
</style>
