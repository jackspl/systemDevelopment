...
public class SceneCloseFolderNewstuff {
    private Integer id;
    ...
    public String getObjectClosed() {
        return objectClosed;
    }

    public void setObjectClosed(String objectClosed) {
        this.objectClosed = objectClosed == null ? null : objectClosed.trim();
    }
    ...
    public void setTimeClosed(String timeClosed) {
        this.timeClosed = timeClosed == null ? null : timeClosed.trim();
    }
}