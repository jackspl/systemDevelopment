    ...
    <el-container>
      ...
      <el-header class="header clearfix">
        ...
        >
          <ul>
            <li
              v-on:mouseover="okInfoChange($event)"
              v-on:mouseout="okInfoRemove($event)"
            >
            ...
            <li
              v-on:mouseover="poutChange($event)"
              v-on:mouseout="poutRemove($event)"
            >
              <i class="iconfont schedule">&#xe636;</i>
            ...
            <li
              v-on:mouseover="addChange($event)"
              v-on:mouseout="addRemove($event)"
            >
              <i class="iconfont schedule">&#xe62b;</i>
            ...
            <li
              v-on:mouseover="permaChange($event)"
              v-on:mouseout="permaRemove($event)"
            >
              <i class="iconfont schedule">&#xe634;</i>
            ...
            <li
              v-on:mouseover="feedChange($event)"
              v-on:mouseout="feedRemove($event)"
            >
              <i class="iconfont schedule">&#xe63d;</i>
      ...
      <el-container class="na_main">
        ...
        <el-aside width="200px" class="aside" v-if="flag">
          <el-menu
            ...
            @open="handleOpen"
            @close="handleClose"
            background-color="#2f3b52" text-color="#a5aab7" active-text-color="#ffd04b"
          >
            <el-submenu index="1">
              <template slot="title">
              ...
              <el-menu-item index="11" style="padding-left: 60px"
                ><span slot="title">Service Status</span></el-menu-item
              >
              <el-menu-item index="/status" style="padding-left: 60px"
                ><span slot="title">Hostgroup Summary</span></el-menu-item
              >
              <el-menu-item index="33" style="padding-left: 60px"
                ><span slot="title">Hostgroup Overview</span></el-menu-item
              >
              <el-menu-item index="44" style="padding-left: 60px"
                ><span slot="title">Hostgroup Grid</span></el-menu-item
              >
            </el-submenu>
            <el-submenu index="2">
              <template slot="title">
              ...
              <el-menu-item index="2-1" style="padding-left: 60px"
                ><span slot="title">PerFormance Graphs</span></el-menu-item
              >
              <el-menu-item index="2-2" style="padding-left: 60px"
                ><span slot="title">Graphs Explorer</span></el-menu-item
              >
            </el-submenu>
            <el-submenu index="3">
              <template slot="title">
              ...
              <el-menu-item index="3-1" style="padding-left: 60px"
                ><span slot="title">BBmap</span></el-menu-item
              >
              <el-menu-item index="3-2" style="padding-left: 60px"
                ><span slot="title">Minemap</span></el-menu-item
              >
            </el-submenu>
          </el-menu>
        </el-aside>
