...
public class SceneGeneralDelete {
    private Integer id;
    ...
    private String crossDepartmentDelete;

    private String crossOwnerDelete;
    ...
    public void setItemTypeClass(String itemTypeClass) {
        this.itemTypeClass = itemTypeClass == null ? null : itemTypeClass.trim();
    }
    ...
    public void setCrossDepartmentDelete(String crossDepartmentDelete) {
        this.crossDepartmentDelete = crossDepartmentDelete == null ? null : crossDepartmentDelete.trim();
    }
    ...
    public void setCrossOwnerDelete(String crossOwnerDelete) {
        this.crossOwnerDelete = crossOwnerDelete == null ? null : crossOwnerDelete.trim();
    }
}