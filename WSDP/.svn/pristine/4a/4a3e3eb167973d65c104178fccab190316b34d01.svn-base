      ...
      <div class="main-middle">
        <div class="border-top-left top_three">
          ...
          <div class="fl w30">
            ...
            <p class="eventNum2 fl">16528.74h</p>
            <i class="iconfont fl workUp">&#xe6a5;</i>
            <p class="workNum fl">182</p>
          </div>
          <div class="fl w30">
            <p class="fl usEvent">KPI：</p>
            <p class="eventNum3 fl">95836</p>
            <i class="iconfont fl KPIUp">&#xe6a5;</i>
            <p class="KPINum fl">209</p>
          </div>
        </div>
...
export default {
  ...
  mounted() {
    ...
    // };
    let resize7 = {
      height: this.initHeight7,
      width: this.initWidth7
    };
    // let resize8 = {
