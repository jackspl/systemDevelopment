...
public class SceneGeneralPaste {
    private Integer id;
    ...
    public String getDestTypeClass() {
        return destTypeClass;
    }

    public void setDestTypeClass(String destTypeClass) {
        this.destTypeClass = destTypeClass == null ? null : destTypeClass.trim();
    }
